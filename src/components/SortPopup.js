...
export const SortPopup = React.memo(({ items, activeSortType, onClickSortBy }) => {
  ...
  const heandleOutsideClick = (event) => {
  ...
  useEffect(() => {
    document.body.addEventListener('click', heandleOutsideClick);
  }, []);
